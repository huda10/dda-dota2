...
class Dataskills(db.Model):
    ...
    matchId = db.Column(db.character[])
    kills = db.Column(db.real)
    deaths = db.Column(db.real)
    assists = db.Column(db.real)
    last_hits = db.Column(db.real)
    denies = db.Column(db.real)
    gold_per_min = db.Column(db.real)
    xp_per_min = db.Column(db.real)
    capability_level = db.Column(db.real)
    potency_level = db.Column(db.real)
    time = db.Column(db.real)
    final_level = db.Column(db.real)
